    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    ExerciseName = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: false),
                    ExerciseDescription = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    MuscleName = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    Gender = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProgramDescription = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    AppUserId = table.Column<Guid>(type: "uuid", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    BlockName = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    WorkoutName = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: false),
                    AvPerformanceTime = table.Column<int>(type: "integer", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    RepAmount = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    UsedWeight = table.Column<decimal>(type: "numeric", nullable: false),
                    WorkoutSetId = table.Column<Guid>(type: "uuid", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reps_WorkoutSetId",
                table: "Reps",
                column: "WorkoutSetId");

            migrationBuilder.CreateIndex(
                name: "IX_TrainingBlocks_AppUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TrainingPrograms_AppUserId",
                table: "TrainingPrograms",
                column: "AppUserId");

            migrationBuilder.CreateIndex(
                name: "IX_UserPrograms_AppUserId",
                table: "UserPrograms",
                column: "AppUserId");

            migrationBuilder.CreateIndex(
                name: "IX_UserPrograms_TrainingProgramId",
                table: "UserPrograms",
                column: "TrainingProgramId");

            migrationBuilder.CreateIndex(
                name: "IX_Weights_WorkoutSetId",
                table: "Weights",
                column: "WorkoutSetId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Workouts_TrainingBlockId",
                table: "Workouts",
